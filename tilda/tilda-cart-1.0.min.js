function tcart__init(t) {
    var o = $(".t706");
    if (void 0 !== window.tcart_initted && "yes" == window.tcart_initted && 1 < o.length) {
        $(".t706__previewmode-infobox center").append('<div style="color:red;">Error: Two cart widgets on the page</div>')
    } else {
        var r;
        void 0 !== (r = o.attr("data-cart-dontstore")) && "y" == r && (window.tcart_dontstore = "y"),
        void 0 !== (r = o.attr("data-cart-oneproduct")) && "y" == r && (window.tcart_oneproduct = "y"),
        void 0 !== (r = o.attr("data-cart-maxstoredays")) && "" != r && 0 <= r && (window.tcart_maxstoredays = r),
        void 0 !== (r = o.attr("data-cart-sendevent-onadd")) && "y" == r && (window.tcart_sendevent_onadd = "y"),
        ...
        o.find(".t-input-group_pm").length && o.find(".t-input-group_pm").find(".t-input-title").html(tcart__dict(6, "Payment method"))
    }
}
function tcart__dict(t) {
    ...
    r = {
        ...
        UA: "Мінімальна кількість у замовленні",
        JA: "最小注文数",
        CN: "最小的总数。"
    };
    o[12] = r;
...
function tcart__loadLocalObj() {
    ...
    void 0 !== window.tcart_maxstoredays && "" != window.tcart_maxstoredays) {
        var o = window.tcart_maxstoredays;
        if (0 < o) {
            if (void 0 !== window.tcart.updated && 0 < window.tcart.updated)
                86400 * o < 1 * Math.floor(Date.now() / 1e3) - 1 * window.tcart.updated && (window.tcart = tcart__nullObj())
        } else
            "0" == o && (window.tcart = tcart__nullObj())
    } else {
        if (void 0 !== window.tcart.updated && 0 < window.tcart.updated)
            2592e3 < 1 * Math.floor(Date.now() / 1e3) - 1 * window.tcart.updated && (window.tcart = tcart__nullObj())
    }
    void 0 !== window.tcart_dontstore && "y" == window.tcart_dontstore && (window.tcart = tcart__nullObj()),
    ...
    var r = $(".t706").attr("data-project-currency-dec");
    window.tcart.currency_dec = void 0 !== r && "00" == r ? r : "",
    delete window.tcart.system;
    var a = $(".t706").attr("data-payment-system");
    window.tcart.system = void 0 !== a && "" != a ? a : "none";
    var i = $(".t706").attr("data-cart-minorder");
    void 0 !== i && "" != i && 0 < i && void 0 === window.tcart_minorder && (i *= 1,
    window.tcart_minorder = i,
    $(".t706__cartwin-prodamount-wrap").prepend('<div class="t706__cartwin-prodamount-minorder" style="opacity:0.5; font-size:14px; font-weight:400;">' + tcart__dict(11, "Minimal order") + ": " + tcart__showPrice(i) + "</div>"));
    var c = $(".t706").attr("data-cart-mincntorder");
    void 0 !== c && "" != c && 0 < c && void 0 === window.tcart_mincntorder && (c *= 1,
    window.tcart_mincntorder = c,
    $(".t706__cartwin-prodamount-wrap").prepend('<div class="t706__cartwin-prodamount-mincntorder" style="opacity:0.5; font-size:14px; font-weight:400;">' + tcart__dict(12, "Minimal quantity") + ": " + c + "</div>")),
    tcart__addDelivery(),
    tcart__updateTotalProductsinCartObj()
}
function tcart__saveLocalObj() {
    if (!(void 0 !== window.tcart_dontstore && "y" == window.tcart_dontstore || void 0 !== window.tcart_maxstoredays && 0 == window.tcart_maxstoredays || "object" != typeof window.tcart)) {
...
function tcart__syncProductsObject__LStoObj() {
    if (!(void 0 !== window.tcart_dontstore && "y" == window.tcart_dontstore || void 0 !== window.tcart_maxstoredays && 0 == window.tcart_maxstoredays || "object" != typeof localStorage))
        try {
...
function tcart__addEvent__links() {
    $('[href^="#order"]').not("[data-link-event-setted]").click(function(t) {
        t.preventDefault();
        var o = $(this);
        if (o.attr("data-link-event-setted", "yes"),
        void 0 === o.attr("data-dbclk-prevent") || "yes" != o.attr("data-dbclk-prevent")) {
            o.attr("data-dbclk-prevent", "yes"),
            setTimeout(function() {
            ...
            if ("#order:" == r.substring(0, 7)) {
                ...
                if (void 0 !== w && "" != w) {
                    ...
                    var l;
                    if (0 < w.indexOf("="))
                        void 0 !== (l = w.split("="))[0] && (i = l[0]),
                        void 0 !== l[1] && (a = l[1]),
                        a = tcart__cleanPrice(a);
                    else
                        i = w;
                    if (void 0 !== p && "" != p)
                        if (0 < p.indexOf("="))
                            void 0 !== (l = p.split("="))[0] && void 0 !== l[1] && "" != l[0] && "" != l[1] && "image" == l[0] && 0 < l[1].indexOf("tildacdn.com") && (c = l[1]);
                    "" == s && void 0 === (s = o.closest(".r").attr("id").replace("rec", "")) && (s = "")
                }
            }
            var m = $(this).closest(".js-product");
            if (void 0 !== m) {
                if ("" == i && void 0 === (i = m.find(".js-product-name").text()) && (i = ""),
                "" != a && 0 != a || (a = tcart__cleanPrice(a = m.find(".js-product-price").text())),
                "" == c) {
                    var v = m.find(".js-product-img");
                    if (void 0 !== v && (v.is("img") && (c = v.attr("src")),
                    v.is("div"))) {
                        c = "";
                ...
                "" == d && void 0 === (d = m.attr("data-product-lid")) && (d = ""),
                "" == e && void 0 === (e = m.attr("data-product-uid")) && (e = ""),
                "" == s && void 0 === (s = m.closest(".r").attr("id").replace("rec", "")) && (s = ""),
                "" == _ && void 0 === (_ = m.attr("data-product-inv")) && (_ = "");
                var f = [];
                m.find(".js-product-option").each(function() {
                    ...
                    void 0 !== o && void 0 !== r) {
                        var i = {};
                        "" != o && (o = tcart__escapeHtml(o)),
                        "" != r && (r = (r = tcart__escapeHtml(r)).replace(/(?:\r\n|\r|\n)/g, "")),
                        1 < o.length && ":" == o.charAt(o.length - 1) && (o = o.substring(0, o.length - 1)),
                        i.option = o,
                        i.variant = r,
                        i.price = a,
                        f.push(i)
                ...
                "" == n && void 0 === (n = m.find(".js-product-sku").text()) && (n = "")
            }
            if ("" != i || "" != a && 0 != a) {
                "" == i && (i = "NoName"),
                "" == a && (a = 0),
                "" != i && (i = tcart__escapeHtml(i)),
                "" != c && (c = tcart__escapeHtmlImg(c));
                var b = {};
                if (b.name = i,
                b.price = a,
                b.img = c,
                void 0 !== f && 0 < f.length && (b.options = f),
                void 0 !== n && "" != n && (n = tcart__escapeHtml(n),
                b.sku = n),
                void 0 !== e && "" != e && (b.uid = e),
                void 0 !== _ && 0 < _ && (b.inv = parseInt(_)),
                tcart__addProduct(b),
                void 0 !== window.tcart_sendevent_onadd && "y" == window.tcart_sendevent_onadd && window.Tilda && "function" == typeof Tilda.sendEventToStatistics) {
                    ...
                    Tilda.sendEventToStatistics(h, g, j, P)
                }
            }
        }
    })
}
function tcart__addProduct(n) {
    ...
    0 < t.length && $.each(t, function(t, o) {
        if (void 0 !== window.tcart_oneproduct && "y" == window.tcart_oneproduct) {
            if (o.name == n.name && o.price == n.price) {
                if (void 0 === o.options && void 0 === n.options && void 0 === o.sku && void 0 === n.sku)
                    return !(e = "yes");
                if (void 0 === o.options && void 0 === n.options && void 0 !== o.sku && void 0 !== n.sku && o.sku == n.sku)
                    return !(e = "yes")
            }
        } else if (o.name == n.name && o.price == n.price) {
            var r = ""
              , a = ""
              , i = ""
              , c = "";
            if (void 0 === o.options && void 0 === n.options ? i = a = r = "y" : "object" == typeof o.options && "object" == typeof n.options && (void 0 === o.options[0] && void 0 === n.options[0] ? r = "y" : "object" == typeof o.options[0] && "object" == typeof n.options[0] && o.options[0].option == n.options[0].option && o.options[0].variant == n.options[0].variant && o.options[0].price == n.options[0].price && (r = "y"),
            void 0 === o.options[1] && void 0 === n.options[1] ? a = "y" : "object" == typeof o.options[1] && "object" == typeof n.options[1] && o.options[1].option == n.options[1].option && o.options[1].variant == n.options[1].variant && o.options[1].price == n.options[1].price && (a = "y"),
            void 0 === o.options[2] && void 0 === n.options[2] ? i = "y" : "object" == typeof o.options[2] && "object" == typeof n.options[2] && o.options[2].option == n.options[2].option && o.options[2].variant == n.options[2].variant && o.options[2].price == n.options[2].price && (i = "y")),
            (void 0 === o.sku && void 0 === n.sku || o.sku == n.sku) && (c = "y"),
            "y" == r && "y" == a && "y" == i && "y" == c)
                return 0 < window.tcart.products[t].quantity && void 0 !== n.inv && 0 < n.inv && window.tcart.products[t].quantity == n.inv ? alert(tcart__dict(13, "Sorry, limit reached, this is the maximum quantity of goods in stock")) : (window.tcart.products[t].quantity++,
...
function tcart__updateTotalProductsinCartObj() {
    ...
    if (0 < t.length) {
        ...
        var o = window.tcart.prodamount = a;
        if ("object" == typeof window.tcart.promocode && void 0 !== window.tcart.promocode.promocode && "" != window.tcart.promocode.promocode) {
            var i = 0;
            void 0 !== window.tcart.promocode.discountsum && 0 < window.tcart.promocode.discountsum ? i = 1 * window.tcart.promocode.discountsum : void 0 !== window.tcart.promocode.discountpercent && 0 < window.tcart.promocode.discountpercent ? i = tcart__roundPrice(o * window.tcart.promocode.discountpercent * 1 / 100) : console.log("Cart Some error."),
            (o -= i) < 0 && (o = 0),
            window.tcart.prodamount_discountsum = i,
            window.tcart.prodamount_withdiscount = o
        }
        "object" == typeof window.tcart.delivery && void 0 !== window.tcart.delivery.price && 0 < window.tcart.delivery.price && 0 < window.tcart.prodamount && (o += 1 * window.tcart.delivery.price),
        0 < o && (o = tcart__roundPrice(o)),
        window.tcart.amount = o
    } else
...
function tcart__reDrawCartIcon() {
    var t = window.tcart
      , o = $(".t706__carticon");
    1 == t.total && (o.css("opacity", 0),
    o.animate({
        opacity: 1
    }, 300)),
    0 < t.total ? (o.addClass("t706__carticon_showed"),
    o.find(".t706__carticon-counter").html(t.total)) : (o.removeClass("t706__carticon_showed"),
    o.find(".t706__carticon-counter").html("")),
...
function tcart__reDrawProducts() {
    var t = $(".t706__cartwin-products")
      ...
      , r = "";
    if (0 < o.length && $.each(o, function(t, o) {
        "" != o.img && (r = "yes")
    }),
    0 < o.length) {
        var a = "";
        $.each(o, function(t, o) {
            ...
            "yes" == r && (a += '<div class="t706__product-thumb"><div class="t706__product-imgdiv" style="background-image:url(' + o.img + ');"></div></div>'),
            a += '<div class="t706__product-title t-descr t-descr_sm">',
            a += o.name,
            void 0 !== o.options && 0 < o.options.length && (a += '<div style="opacity:0.7;font-size:12px;font-weight:400;">',
            $.each(o.options, function(t, o) {
                a += "<div>" + o.option + ": " + o.variant + "</div>"
            }),
            a += "</div>"),
            void 0 !== o.sku && "" != o.sku && (a += '<div style="opacity:0.7;font-size:12px;font-weight:400;">',
            a += o.sku,
            a += "</div>"),
            a += "</div>",
            ...
            a += '<div class="t706__product-amount t-descr t-descr_sm">',
            0 < o.amount && (a += tcart__showPrice(o.amount)),
            a += "</div>",
...
function tcart__product__plus(t) {
    var o = t.closest(".t706__product")
      , r = o.attr("data-cart-product-i");
    0 < window.tcart.products[r].quantity && void 0 !== window.tcart.products[r].inv && 0 < window.tcart.products[r].inv && window.tcart.products[r].inv == window.tcart.products[r].quantity ? alert(tcart__dict(13, "Sorry, limit reached, this is the maximum quantity of goods in stock")) : (window.tcart.products[r].quantity++,
    ...
    o.find(".t706__product-quantity").html(window.tcart.products[r].quantity),
    0 < window.tcart.products[r].amount ? o.find(".t706__product-amount").html(tcart__showPrice(window.tcart.products[r].amount)) : o.find(".t706__product-amount").html(""),
    tcart__updateTotalProductsinCartObj(),
    $(".t706__carticon-counter").html(window.tcart.total),
    tcart__reDrawTotal(),
    tcart__saveLocalObj())
...
function tcart__product__minus(t) {
    var o = t.closest(".t706__product")
      , r = o.attr("data-cart-product-i");
    0 < window.tcart.products[r].quantity && window.tcart.products[r].quantity--,
    window.tcart.products[r].amount = window.tcart.products[r].price * window.tcart.products[r].quantity,
    window.tcart.products[r].amount = tcart__roundPrice(window.tcart.products[r].amount),
    o.find(".t706__product-quantity").html(window.tcart.products[r].quantity),
    0 < window.tcart.products[r].amount && o.find(".t706__product-amount").html(tcart__showPrice(window.tcart.products[r].amount)),
...
function tcart__addDelivery() {
    var t = $(".t706 .t-form .t-radio__wrapper-delivery input:checked").val()
      , o = $(".t706 .t-form .t-radio__wrapper-delivery input:checked").attr("data-delivery-price");
    if (void 0 !== t && void 0 !== o && "" != t && "" != o) {
        o = tcart__cleanPrice(o);
        var r = t.indexOf("=");
        0 < r && (t = (t = t.substring(0, r)).trim()),
        window.tcart.delivery = {},
        window.tcart.delivery.name = t,
        window.tcart.delivery.price = o
    }
...
function tcart__unlockScroll() {
    if (/iPhone|iPad|iPod/i.test(navigator.userAgent) && !window.MSStream) {
        var t = $("body");
        if (t.hasClass("t-body_scroll-locked")) {
            var o = $("body").attr("data-popup-scrolltop");
